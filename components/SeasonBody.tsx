      ...
      {props.content.map((index: any) => {
        return (
          <div key={index.id} className="grid md:grid-cols-3 grid-cols-1">
            <div
              className={`p-5 relative border-forth border-opacity-60 md:border-b-2 ${
                index.id > 1 ? "-mt-20" : "-mt-20"
              }  h-full`}
            >
            ...
            <div
              className={`p-5 border-forth relative border-opacity-60 border-b-2 ${
                index.id > 1 ? "md:-mt-20 mt-0" : "md:-mt-20 mt-0"
              }  h-full`}
            >
